...
class Subscription(models.Model):
    ...
    invoice_ids = fields.Many2many(
        ...
        copy=False)
    order_line = fields.One2many('sale.order.line', 'order_id', string='Order Lines', copy=True, auto_join=True)
    ...
    @api.depends('subscription_line_ids.price_subtotal', 'subscription_line_ids.price_tax', 'subscription_line_ids.price_total')
